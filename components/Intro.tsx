...
const Intro = () => {
  return (
    <div className="w-full h-[76rem] text-center clip-polygon bg-[#eee]">
      <div className="max-w-[1240px] w-full md:h-[100%] h-[100vh] mx-auto md:my-[-6rem] p-4 flex justify-center items-center">
        <div>
          <h1 className="mb-20">
            Hello, I am{" "}
            {
